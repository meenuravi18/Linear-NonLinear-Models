...
inputData = pandas.read_csv('C:\\MScAnalytics\\Linear and Nonlinear Model\\Data\\claim_history.csv',
                            delimiter = ',', usecols = ['HOMEKIDS', 'KIDSDRIV', 'CLM_COUNT'])
...
outTable = pandas.DataFrame(iterTable, columns = ['Iteration', 'Log-Likelihood', 'Intercept', 'KIDSDRIV', 'HOMEKIDS'])
